...
| --- | --- | --- | --- |
| 1 | SauceDemo | Inicio de sesión, agregar un producto, abrir el carrito y eliminarlo. | [README](./dia1/selenium/README.md) |
| 1 | OrangeHRM | Inicio de sesión, navegación al módulo PIM, búsqueda y selección de un resultado. | [README](./dia1/selenium-Orange-HRM/README.md) |
| 2 | Santander | Recorrido por enlaces de Personas, Empresas, Pymes, Banca Privada y Acerca del Banco. | [README](./dia2/selenium-santander/README.md) |
